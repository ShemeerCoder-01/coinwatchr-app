...
function HomePage() {
  ...
  return (
    <div>
      <Header/>
      <MainComponent/>
      <AppDetails img={dashboarimg} heading={"Real-time Crypto Tracking"} Description={"Stay up-to-date with the ever-changing crypto market. Our application allows you to effortlessly track various cryptocurrencies in real-time, providing you with accurate and timely data on their current prices, market cap, volume, and more."} margin={window.screen.width <= 1000?"28rem":"20rem"} align/>
